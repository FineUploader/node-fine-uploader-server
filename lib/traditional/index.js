    ...
    return {
        'upload': function(req, res, next){
            ...
            if (req.body[params.chunkIndex] &&
                req.body[params.chunkIndex] <= req.body[params.totalChunks] - 1){
                ...
                storage.store_chunk(uploadedFile).then(function(){
                    ...
                    if (parseInt(uploadedFile.chunkIndex) === parseInt(uploadedFile.totalChunks) - 1){
                        debug('assembling chunks');
